...
Same quiet field as 0.2.5. Fresh Steam Deck cut: download `Dimple-0.2.6-linux-x64.tar.gz` (~426 MB). Unpack into `~/Dimple` and run `/home/deck/Dimple/Dimple --no-sandbox`.
